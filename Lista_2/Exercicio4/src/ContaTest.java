...
public class ContaTest {
	...
	public void testContador(){
		int count = Conta.getCont();
		new Conta("Senhor Ninguem", 123, 13, 123456789);
		assertEquals("Contador não foi incrementado após instanciar uma conta", count + 1, Conta.getCont());
	}
	...
	public void testIdentificador(){
		int count = Conta.getCont();
		Conta conta = new Conta("Senhor Ninguem", 123, 13, 123456789);
		assertEquals("Primeira conta não está com id igual a 1", count + 1, conta.getId());
	}
