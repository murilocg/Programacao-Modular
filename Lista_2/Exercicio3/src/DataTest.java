...
public class DataTest {
	...
	public void testPorExtenso() {
		porExtensoHelper(2018, 2, 19, "19 de fevereiro de 2018");
	}

	@Test(timeout = TIME_OUT)
	public void testPorExtensoDataInvalida() {
		porExtensoHelper(2, 19, 2018, "Data inválida");
	}
	...
	private void porExtensoHelper(int ano, int mes, int dia, String resultadoEsperado) {
		Data data = new Data(ano, mes, dia);
		assertEquals("Data por extenso está incorreta para " + ano + "/" + mes + "/" + dia, resultadoEsperado,
				data.porExtenso());
	}
